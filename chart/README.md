...
> [!WARNING]
> This chart is currently marked as a pre-release and targets DAMAP 5.0.0-rc.2. It is intended for evaluation and testing.
...
```bash
helm install damap oci://ghcr.io/damap-org/damap-chart --version 0.1.0-rc.2
```

Upgrade:

```bash
helm upgrade damap oci://ghcr.io/damap-org/damap-chart --version 0.1.0-rc.2
```
...
| Variable          | Description                                                                                                                                                                                                                                                                                                 | Default                                                                                                                                                                                                                                          |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| backendVersion    | Backend image tag                                                                                                                                                                                                                                                                                           | 5.0.0-rc.2                                                                                                                                                                                                                                       |
...
| frontendVersion   | Frontend image tag                                                                                                                                                                                                                                                                                          | 5.0.0-rc.2                                                                                                                                                                                                                                       |
...
| tenants             | List of tenant identifiers                 | [tenant_1, tenant_2] |
